...
typedef enum
{
    ...
    // these are just recommondations
...
typedef struct
{
    ...
    // Pointer to Array or Struct or Function structs
...
#endif
static VariableType AnyVariableType = {None, 0, Qualifier_None, NULL, 1};
static VariableType MachineUIntType = {UintKeyword, 0, Qualifier_None, NULL, 1};
static VariableType MachineIntType = {IntKeyword, 0, Qualifier_None, NULL, 1};
static VariableType MachineInt32Type = {Int32Keyword, 0, Qualifier_None, NULL, 1};
static VariableType MachineUInt32Type = {Uint32Keyword, 0, Qualifier_None, NULL, 1};
#ifndef CUSTOM_COMP
